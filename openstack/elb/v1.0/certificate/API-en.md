...
This interface is used to create a certificate for HTTPS.
## func Delete
    func Delete(*golangsdk.ServiceClient, string, string) (DeleteResult)  
This interface is used to delete a certificate.
## func List
...
This interface is used to change the name and description of a certificate.
