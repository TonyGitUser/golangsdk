...
var CreateResponse = privateips.CreateResponse{
...
func HandleCreateSuccessfully(t *testing.T) {
	th.Mux.HandleFunc("/v1/57e98940a77f4bb988a21a7d0603a626/privateips", func(w http.ResponseWriter, r *http.Request) {
...
`
var GetResponse = privateips.GetResponse{
...
func HandleGetSuccessfully(t *testing.T) {
	th.Mux.HandleFunc("/v1/57e98940a77f4bb988a21a7d0603a626/privateips/ea274524-f1cc-4078-8e67-c002be25c413", func(w http.ResponseWriter, r *http.Request) {
...
var ListResponse = privateips.ListResponse{
	Privateips: []privateips.PrivateIp{
		{
...
func HandleListSuccessfully(t *testing.T) {
	th.Mux.HandleFunc("/v1/57e98940a77f4bb988a21a7d0603a626/subnets/5ae24488-454f-499c-86c4-c0355704005d/privateips", func(w http.ResponseWriter, r *http.Request) {
		th.TestMethod(t, r, "GET")
		th.TestHeader(t, r, "X-Auth-Token", client.TokenID)
